...
const Sidebar = ({ children }) => {
  ...
  function postData(e){
    ...
    axios.post('https://9b7em.sse.codesandbox.io/create', newMeeting)
    .then((response) => {
  ...
  return (
        ...
        <form className="d-flex flex-column align-items-center container-sm my-4 pt-3 p-sm-5" noValidate autoComplete="off">
          ...
          <div className="container d-flex flex-column align-content-center my-3">          
            ...
            <div className="d-inline-flex flex-column flex-sm-row justify-content-center justify-content-lg-start align-items-center">
